...
PYG_API torch::Tensor radius(torch::Tensor x, torch::Tensor y,
...
TORCH_LIBRARY_FRAGMENT(pyg, m) {
  m.def(TORCH_SELECTIVE_SCHEMA(
      "pyg::radius(Tensor x, Tensor y, Tensor? ptr_x, Tensor? ptr_y, double r,"
      " int64 max_num_neighbours, int64 num_workers) -> Tensor"));
}
